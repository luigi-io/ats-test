...
This command starts a local development server and opens up a browser window at `http://localhost:3010/`. Most changes are reflected live without having to restart the server.

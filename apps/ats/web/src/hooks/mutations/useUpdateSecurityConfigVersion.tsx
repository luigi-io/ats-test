...
export const useUpdateSecurityConfigVersion = () => {
  ...
  return useMutation((req: UpdateConfigVersionRequest) => SDKService.updateSecurityConfigVersion(req), {
    onSuccess(data, variables) {
      queryClient.invalidateQueries({
        queryKey: [GET_CONFIG_INFO(variables.securityId)],
      });

      console.log("SDK message --> Management update configuration version success: ", data);

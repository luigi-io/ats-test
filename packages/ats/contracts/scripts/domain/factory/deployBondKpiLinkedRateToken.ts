...
export interface ImpactDataParams {
 ...
 * ```
 */
export async function deployBondKpiLinkedRateFromFactory(
  ...
  const event = receipt?.logs.find(
    (log) => "eventName" in log && (log as EventLog).eventName === "BondKpiLinkedRateDeployed",
